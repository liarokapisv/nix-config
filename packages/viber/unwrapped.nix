{ lib, fetchurl, makeBinaryWrapper, autoPatchelfHook, dpkg, alsa-lib, nss
, gst_all_1, stdenvNoCC, xorg, lcms, libwebp, snappy, gdk-pixbuf, libmng, gtk3
, pango, libtiff, tslib, mtdev, libxslt, libpulseaudio, mesa, xcb-util-cursor
, libxkbcommon, libglvnd, brotli, cups, libevent, fontconfig, freetype, libkrb5
, harfbuzz, nspr, python311Packages, zstd, udev }:
...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    ...
    url =
      "https://web.archive.org/web/20231030150355/https://download.cdn.viber.com/cdn/desktop/Linux/viber.deb";
